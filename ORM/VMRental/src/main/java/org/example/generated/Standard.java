...
//   */
//  public Standard(java.util.UUID entityId, Integer maxRentedMachines, CharSequence name) {
...
//   * @return A new Standard RecordBuilder
//   */
//  public static Builder newBuilder(Standard other) {
//    if (other == null) {
//      return new Builder();
//    } else {
//      return new Builder(other);
...
//     * @param other The existing instance to copy.
//     */
//    private Builder(Standard other) {
//      super(SCHEMA$);
//      if (isValidValue(fields()[0], other.entityId)) {
//        this.entityId = data().deepCopy(fields()[0].schema(), other.entityId);
