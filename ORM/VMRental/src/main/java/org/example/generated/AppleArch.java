...
//public class AppleArch extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
//  private static final long serialVersionUID = 1078799391191023484L;
//
//
//  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AppleArch\",\"namespace\":\"org.example.generated\",\"fields\":[{\"name\":\"entityId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"CPUNumber\",\"type\":\"int\"},{\"name\":\"ramSize\",\"type\":\"string\"},{\"name\":\"isRented\",\"type\":\"int\"},{\"name\":\"actualRentalPrice\",\"type\":\"float\"}]}");
...
//  }
//
//  private static final BinaryMessageEncoder<AppleArch> ENCODER =
//      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);
//
//  private static final BinaryMessageDecoder<AppleArch> DECODER =
...
//   */
//  public static BinaryMessageEncoder<AppleArch> getEncoder() {
//    return ENCODER;
//  }
//
//  /**
...
//   */
//  public static BinaryMessageDecoder<AppleArch> getDecoder() {
//    return DECODER;
//  }
//
//  /**
...
//   */
//  public static BinaryMessageDecoder<AppleArch> createDecoder(SchemaStore resolver) {
//    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
//  }
//
//  /**
//   * Serializes this AppleArch to a ByteBuffer.
...
//
//  /**
//   * Deserializes a AppleArch from a ByteBuffer.
//   * @param b a byte buffer holding serialized data for an instance of this class
//   * @return a AppleArch instance decoded from the given buffer
//   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
//   */
//  public static AppleArch fromByteBuffer(
...
//   */
//  public AppleArch(java.util.UUID entityId, Integer CPUNumber, CharSequence ramSize, Integer isRented, Float actualRentalPrice) {
...
//
//  /**
//   * Creates a new AppleArch RecordBuilder.
//   * @return A new AppleArch RecordBuilder
//   */
...
//
//  /**
//   * Creates a new AppleArch RecordBuilder by copying an existing Builder.
...
//
//  /**
//   * Creates a new AppleArch RecordBuilder by copying an existing AppleArch instance.
//   * @param other The existing instance to copy.
//   * @return A new AppleArch RecordBuilder
//   */
//  public static Builder newBuilder(AppleArch other) {
//    if (other == null) {
//      return new Builder();
//    } else {
//      return new Builder(other);
...
//
//  /**
//   * RecordBuilder for AppleArch instances.
//   */
//  @org.apache.avro.specific.AvroGenerated
//  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AppleArch>
//    implements org.apache.avro.data.RecordBuilder<AppleArch> {
//
//    private java.util.UUID entityId;
//    private int CPUNumber;
//    private CharSequence ramSize;
...
//
//    /**
//     * Creates a Builder by copying an existing AppleArch instance
//     * @param other The existing instance to copy.
//     */
//    private Builder(AppleArch other) {
//      super(SCHEMA$);
//      if (isValidValue(fields()[0], other.entityId)) {
//        this.entityId = data().deepCopy(fields()[0].schema(), other.entityId);
...
//    public AppleArch build() {
//      try {
//        AppleArch record = new AppleArch();
...
//
//  @SuppressWarnings("unchecked")
//  private static final org.apache.avro.io.DatumWriter<AppleArch>
//    WRITER$ = (org.apache.avro.io.DatumWriter<AppleArch>)MODEL$.createDatumWriter(SCHEMA$);
//
...
//
//  @SuppressWarnings("unchecked")
//  private static final org.apache.avro.io.DatumReader<AppleArch>
//    READER$ = (org.apache.avro.io.DatumReader<AppleArch>)MODEL$.createDatumReader(SCHEMA$);
//
